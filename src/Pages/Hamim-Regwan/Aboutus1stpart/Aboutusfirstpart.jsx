      ...
      <Container>
        ...
        <div className=" lg:flex justify-between py-20 lg:px-4  space-y-5">
          <div>
            ...
            <h1 className=" lg:w-[595px] text-3xl md:text-5xl font-semibold font-Poppins text-Dark-Blue leading-[74px]  md:pb-[31px]  dark:text-white text-center lg:text-left">
