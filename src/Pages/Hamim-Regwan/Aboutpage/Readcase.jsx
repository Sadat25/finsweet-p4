  ...
  return (
    <div className={`${click ? 'dark':'' } dark:bg-Tint-Blue dark:text-white`} >
      <div className='container grid-cols-4 '>
          ...
          <div className='lg:w-209 mt-16 m-auto grid-cols-2 lg:pl-0 pl-6'>
           <h1 className='font-Poppins font-semibold text-38px'>How we do it</h1>
           <p className='font-Poppins pt-3'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
           <div>
            <div className='flex gap-5 items-center pt-6'>
                <div className='w-1.5 h-1.5 bg-black rounded-full dark:bg-white'></div>
          ...
          <div className='mt-32 grid-cols-3'>
            ...
            <div className='flex justify-center items-center mt-14'>
                 <button onClick={handlechange} className='bg-[#FCD980] px-6 py-3 rounded-[50px] cursor-pointer hover:bg-Royal-Blue text-[18px] font-semibold font-Manrope  '>Contact Us</button>
            </div>
