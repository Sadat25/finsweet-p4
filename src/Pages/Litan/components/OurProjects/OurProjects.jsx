        ...
        <div className='bg-white py-10 md:py-20 dark:bg-slate-800'>
            <div className="container px-5 md:px-0">
                <div className="flex justify-between items-center mb-10">
                    <h3 className='md:text-5xl text-3xl font-bold'>View our projects</h3>
                ...
                <div className="flex justify-between gap-8 flex-col md:flex-row">
                    <div className="md:w-8/12">
                        <div className="relative group duration-300  overflow-hidden">
                            ...
                            <div className="bg-linear-to-b from-blue-300/50 to-slate-900 absolute inset-0 flex justify-center items-center opacity-0 group-hover:opacity-100 duration-800 ease-in-out transition-all -translate-x-full group-hover:translate-x-0">
                                <div className="">
                    ...
                    <div className="md:w-4/12">
                        <div className="space-y-8">
                            <div className="relative group duration-300 w-full overflow-hidden">
