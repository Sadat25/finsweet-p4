            ...
            <div className="container px-5 md:px-0">
                <div className="flex justify-between gap-8 flex-col md:flex-row">
                    ...
                    <div className="md:w-9/12">
                        <h4 className='md:text-3xl text-xl font-medium mb-10'>"The best agency we’ve worked with so far. They understand our product and are able to add new features with a great focus."</h4>
