      ...
      <section className="py-10 md:py-[60px] lg:py-[95px] dark:bg-Dark-Blue bg-[#F4F6FC]">
        <Container>
          <div className="text-center">
            <h5 className="font-Poppins text-sm md:text-base font-medium dark:bg-[#F4F6FC] text-Dark-Blue">
              What we created
            </h5>
            <h3 className="font-Poppins text-[28px] md:text-[38px] lg:text-[48px] font-semibold dark:bg-[#F4F6FC] text-Dark-Blue">
              Our Work Portfolio
            </h3>
            <p className="font-Poppins m-auto text-[8px] md:text-base md:font-medium dark:bg-[#F4F6FC] text-Dark-Blue w-[360px] md:w-[722px] lg:w-[742px] py-5 md:py-7 lg:py-10">
